...
})(exports.SliderOrientation || (exports.SliderOrientation = {})); // TODO: Remove in 1.0
...
})(exports.SliderHandleAlignment || (exports.SliderHandleAlignment = {})); // TODO: Remove in 1.0
...
var Slider = /*#__PURE__*/utils.forwardRefWithAs(function Slider(_ref, forwardedRef) {
  var children = _ref.children,
      props = _objectWithoutPropertiesLoose(_ref, ["children"]);

  return React__default.createElement(SliderInput, Object.assign({}, props, {
    ref: forwardedRef,
    "data-reach-slider": "",
    _componentName: "Slider"
  }), React__default.createElement(SliderTrack, null, React__default.createElement(SliderTrackHighlight, null), React__default.createElement(SliderHandle, null), children));
});
...
var SliderInput = /*#__PURE__*/utils.forwardRefWithAs(function SliderInput(_ref2, forwardedRef) {
  ...
  utils.useControlledSwitchWarning(controlledValue, "value", _componentName);
   utils.warning(!DEPRECATED_getValueText, "The `getValueText` prop in @reach/slider is deprecated. Please use `getAriaValueText` instead.") ;
  ...
  var _useControlledState = utils.useControlledState(controlledValue, defaultValue || min),
  ...
  var handleKeyDown = utils.useEventCallback(function (event) {
    if (disabled) {
      return;
    }
  ...
  var removeMoveEvents = React.useRef(utils.noop);
  var removeStartEvents = React.useRef(utils.noop);
  var removeEndEvents = React.useRef(utils.noop); // Store our event handlers in refs so we aren't attaching/detaching events
  ...
  var handleSlideStart = utils.useEventCallback(function (event) {
  ...
  var setPointerCapture = utils.useEventCallback(function (event) {
  ...
  var releasePointerCapture = utils.useEventCallback(function (event) {
  ...
  var handlePointerMove = utils.useEventCallback(function (event) {
  ...
  var handleSlideStop = utils.useEventCallback(function (event) {
    pointerDownRef.current = false;
    var newValue = getNewValueFromEvent(event);
  ...
  var addMoveListener = React.useCallback(function () {
    ...
    var touchListener = utils.wrapEvent(appEvents.current.onTouchMove, handlePointerMove);
    var mouseListener = utils.wrapEvent(appEvents.current.onMouseMove, handlePointerMove);
  ...
  var addEndListener = React.useCallback(function () {
    var ownerDocument = utils.getOwnerDocument(sliderRef.current) || document;
    var pointerListener = utils.wrapEvent(appEvents.current.onPointerUp, releasePointerCapture);
    var touchListener = utils.wrapEvent(appEvents.current.onTouchEnd, handleSlideStop);
    var mouseListener = utils.wrapEvent(appEvents.current.onMouseUp, handleSlideStop);
  ...
  var addStartListener = React.useCallback(function () {
    var touchListener = utils.wrapEvent(appEvents.current.onTouchStart, handleSlideStart);
    var mouseListener = utils.wrapEvent(appEvents.current.onMouseDown, handleSlideStart);
    var pointerListener = utils.wrapEvent(appEvents.current.onPointerDown, setPointerCapture); // e.preventDefault is ignored by React's synthetic touchStart event, so
...
var SliderTrackImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderTrack(_ref3, forwardedRef) {
...
var SliderTrack = /*#__PURE__*/utils.memoWithAs(SliderTrackImpl);
...
var SliderTrackHighlightImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderTrackHighlight(_ref4, forwardedRef) {
...
var SliderTrackHighlight = /*#__PURE__*/utils.memoWithAs(SliderTrackHighlightImpl);
...
var SliderHandleImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderHandle(_ref5, forwardedRef) {
...
var SliderHandle = /*#__PURE__*/utils.memoWithAs(SliderHandleImpl);
...
var SliderMarkerImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderMarker(_ref6, forwardedRef) {
  ...
  return inRange ? React__default.createElement(Comp, Object.assign({
    ref: forwardedRef,
    style: _extends({
      position: "absolute"
    }, isVertical ? {
...
var SliderMarker = /*#__PURE__*/utils.memoWithAs(SliderMarkerImpl);
